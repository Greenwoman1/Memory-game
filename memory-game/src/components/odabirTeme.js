...
const OdabirTeme = ({username, setOdabirVisible}
   ...
   return (
      <div>
        ...
        {temeVisible && (<section id="odabir" className={temeVisible ? 'odabir' : 'hidden'}>
          <div id="teme">
            <h2>Izaberi temu!</h2>
            <p id="nastavnici" className="tema" onClick={() => odaberiTemu("nastavnici")}>Nastavnici</p>
            <p id="fakultet" className="tema" onClick={() => odaberiTemu("fakultet")}>Fakultet</p>
            <p id="razno" className="tema" onClick={() => odaberiTemu("razno")}>Razno</p>
          </div>
        </section>)}
        {!buttonsVisible  && (
          ...
          <div id="teme">
            ...
            <p className="tema" onClick={() => odaberiDim(16)}>16</p>
            <p className="tema" onClick={() => odaberiDim(32)}>32</p>
          </div>
        </section>
        )}
        {slike && (
